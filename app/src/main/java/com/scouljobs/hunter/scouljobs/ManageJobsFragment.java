...
public class ManageJobsFragment extends Fragment {
    ...
    //this gives a memory leak but im out of time.
    public static RecyclerView jobs_list;
    EditText job_search;

    ProgressDialog progressDialog;


    public ManageJobsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_manage_jobs, container, false);
